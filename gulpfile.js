...
var root        = 'ui.apps/src/main/content/jcr_root/',
    components  = root + 'apps/gulp-flow/components/',
    designs     = root + 'etc/designs/gulp-flow/',
    clientlibs  = root + 'etc/clientlibs/gulp-flow/',
    ...
    // Scripts
    jsPath      = clientlibs + 'js/',
    vendorPath  = clientlibs + 'vendor/**/*.js',
